...
import { Theme, Link, Image, Text, Box, Hr, Section, List, Input, LinkBox, Button } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { GlobalQuarklyPageStyles } from "global-page-styles";
import { RawHtml, Formspree, Override, Menu } from "@quarkly/components";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"secundario"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
